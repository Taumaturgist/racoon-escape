...
public class Serializer : MonoBehaviour
{
    ...
    public PlayerData Load()
    {
        ...
        if (dictString == "")
        {
            dictString = "ChevroletCamaroSS1969,Lvl1;ToyotaTundra,Locked;NissanSkylineGT,Locked;DodgeViperGTS,Locked;MercedesBenzGCLass,Locked;LamborghiniHuracanLP700,Locked";
        }
